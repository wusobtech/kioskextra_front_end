...
export default class Order_tracking extends Component {
    render() {
        return (
            <div> 
      <div>
          ...
          <div className="ps-order-tracking">
            <div className="container">
              ...
              <div className="ps-section__content">
                <form className="ps-form--order-tracking" action="http://nouthemes.net/html/martfury/index.html" method="get">
                  <div className="form-group">
                    <label>Order ID</label>
                    <input className="form-control" type="text" placeholder="Found in your order confimation email" />
                  </div>
                  <div className="form-group">
