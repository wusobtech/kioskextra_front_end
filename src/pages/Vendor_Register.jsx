...
export default class Vendor_Register extends Component {
    render() {
        return (
            <div>
              <div className="ps-page--single">
                ...
                <div className="ps-vendor-banner bg--cover" data-background="assets/img/bg/vendor.jpg">
                  <div className="container">
                    <h2>Millions Of Shoppers Can’t Wait To See What You Have In Store</h2><a className="ps-btn ps-btn--lg" href="#">Start Selling</a>
                  </div>
                </div>
                <div className="ps-section--vendor ps-vendor-about">
                  <div className="container">
                    <div className="ps-section__header">
                      <p>WHY SELL ON KIOSKEXTRA</p>
                      ...
                      <div className="row">
                        <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                          <div className="ps-block--icon-box-2">
                            <div className="ps-block__thumbnail"><img src="assets/img/icons/vendor-1.png" alt="" /></div>
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                          <div className="ps-block--icon-box-2">
                            <div className="ps-block__thumbnail"><img src="assets/img/icons/vendor-2.png" alt="" /></div>
                            <div className="ps-block__content">
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                          <div className="ps-block--icon-box-2">
                            <div className="ps-block__thumbnail"><img src="assets/img/icons/vendor-3.png" alt="" /></div>
                            <div className="ps-block__content">
                              <h4>Support 24/7</h4>
                              <div className="ps-block__desc" data-mh="about-desc">
                                <p>Our tools and services make it easy to manage, promote and grow your business.</p>
                  ...
                  <div className="container">
                    ...
                    <div className="ps-section__content">
                      <div className="ps-block--vendor-milestone">
                        ...
                        <div className="ps-block__right"><img src="assets/img/vendor/milestone-1.png" alt="" /></div>
                      ...
                      <div className="ps-block--vendor-milestone reverse">
                        ...
                        <div className="ps-block__right"><img src="assets/img/vendor/milestone-2.png" alt="" /></div>
                      ...
                      <div className="ps-block--vendor-milestone">
                        ...
                        <div className="ps-block__right"><img src="assets/img/vendor/milestone-3.png" alt="" /></div>
                      ...
                      <div className="ps-block--vendor-milestone reverse">
                        ...
                        <div className="ps-block__right"><img src="assets/img/vendor/milestone-4.png" alt="" /></div>
                ...
                <div className="ps-section--vendor ps-vendor-best-fees">
                  <div className="container">
                    ...
                    <div className="ps-section__content">
                      ...
                      <div className="ps-section__highlight"><img src="assets/img/icons/vendor-4.png" alt="" />
                        <figure>
                ...
                <div className="ps-section--vendor ps-vendor-testimonials">
                  <div className="container">
                    ...
                    <div className="ps-section__content">
                      <div className="ps-carousel--nav owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed={10000} data-owl-gap={30} data-owl-nav="true" data-owl-dots="true" data-owl-item={2} data-owl-item-xs={1} data-owl-item-sm={1} data-owl-item-md={1} data-owl-item-lg={2} data-owl-duration={1000} data-owl-mousedrag="on">
                        <div className="ps-block--testimonial">
                          <div className="ps-block__header"><img src="assets/img/users/1.jpg" alt="" /></div>
                          <div className="ps-block__content"><i className="icon-quote-close" />
                        ...
                        <div className="ps-block--testimonial">
                          <div className="ps-block__header"><img src="assets/img/users/2.png" alt="" /></div>
                          <div className="ps-block__content"><i className="icon-quote-close" />
                        ...
                        <div className="ps-block--testimonial">
                          <div className="ps-block__header"><img src="assets/img/users/3.jpg" alt="" /></div>
                          <div className="ps-block__content"><i className="icon-quote-close" />
                ...
                <div className="ps-section--vendor ps-vendor-faqs">
                  <div className="container">
                    ...
                    <div className="ps-section__footer">
                      <p>Still have more questions? Feel free to contact us.</p><a className="ps-btn" href="#">Contact Us</a>
                    </div>
                  </div>
                </div>
                <div className="ps-vendor-banner bg--cover" data-background="assets/img/bg/vendor.jpg">
                  <div className="container">
                    <h2>It's time to start making money.</h2><a className="ps-btn ps-btn--lg" href="#">Start Selling</a>
                  </div>
                </div>
              </div>
