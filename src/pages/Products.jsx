        ...
        return (
            <div>
                ...
                <div className="ps-container">
                    ...
                    <div className="ps-carousel--nav-inside owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed={5000} data-owl-gap={0} data-owl-nav="true" data-owl-dots="true" data-owl-item={1} data-owl-item-xs={1} data-owl-item-sm={1} data-owl-item-md={1} data-owl-item-lg={1} data-owl-duration={1000} data-owl-mousedrag="on"><a href="#"><img src="img/slider/shop-default/1.jpg" alt="" /></a><a href="#"><img src="img/slider/shop-default/2.jpg" alt="" /></a></div>
                    </div>
                    <div className="ps-shop-brand"><a href="#"><img src="img/brand/1.jpg" alt="" /></a><a href="#"><img src="img/brand/2.jpg" alt="" /></a><a href="#"><img src="img/brand/3.jpg" alt="" /></a><a href="#"><img src="img/brand/4.jpg" alt="" /></a><a href="#"><img src="img/brand/5.jpg" alt="" /></a><a href="#"><img src="img/brand/6.jpg" alt="" /></a><a href="#"><img src="img/brand/7.jpg" alt="" /></a><a href="#"><img src="img/brand/8.jpg" alt="" /></a></div>
                    ...
                    <div className="row align-content-lg-stretch">
                        ...
                        <div className="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--category-2" data-mh="categories">
                            <div className="ps-block__thumbnail"><img src="img/categories/shop/3.jpg" alt="" /></div>
                            <div className="ps-block__content">
                        ...
                        <div className="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--category-2" data-mh="categories">
                            <div className="ps-block__thumbnail"><img src="img/categories/shop/4.jpg" alt="" /></div>
                            <div className="ps-block__content">
                            <h4>Health &amp; Beauty</h4>
                            <ul>
                        ...
                        <div className="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--category-2" data-mh="categories">
                            <div className="ps-block__thumbnail"><img src="img/categories/shop/7.jpg" alt="" /></div>
                            <div className="ps-block__content">
                        ...
                        <div className="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--category-2" data-mh="categories">
                            <div className="ps-block__thumbnail"><img src="img/categories/shop/8.jpg" alt="" /></div>
                            <div className="ps-block__content">
                            <h4>Sport &amp; Outdoor</h4>
                            <ul>
                    ...
                    <div className="ps-layout__left">
                        ...
                        <ul className="ps-list--categories">
                            <li className="current-menu-item menu-item-has-children"><a href="shop-default.html">Clothing &amp; Apparel</a><span className="sub-toggle"><i className="fa fa-angle-down" /></span>
                            ...
                            <li className="current-menu-item menu-item-has-children"><a href="shop-default.html">Garden &amp; Kitchen</a><span className="sub-toggle"><i className="fa fa-angle-down" /></span>
                            <ul className="sub-menu">
                            ...
                            <li className="current-menu-item menu-item-has-children"><a href="shop-default.html">Consumer Electrics</a><span className="sub-toggle"><i className="fa fa-angle-down" /></span>
                            <ul className="sub-menu">
                                <li className="current-menu-item menu-item-has-children"><a href="shop-default.html">Air Conditioners</a><span className="sub-toggle"><i className="fa fa-angle-down" /></span>
                                <ul className="sub-menu">
                                    <li className="current-menu-item "><a href="shop-default.html">Accessories</a>
                                    </li>
                                ...
                                <li className="current-menu-item menu-item-has-children"><a href="shop-default.html">Audios &amp; Theaters</a><span className="sub-toggle"><i className="fa fa-angle-down" /></span>
                                <ul className="sub-menu">
                                ...
                                <li className="current-menu-item menu-item-has-children"><a href="shop-default.html">Car Electronics</a><span className="sub-toggle"><i className="fa fa-angle-down" /></span>
                                <ul className="sub-menu">
                                ...
                                <li className="current-menu-item menu-item-has-children"><a href="shop-default.html">Office Electronics</a><span className="sub-toggle"><i className="fa fa-angle-down" /></span>
                                <ul className="sub-menu">
                                ...
                                <li className="current-menu-item menu-item-has-children"><a href="shop-default.html">TV Televisions</a><span className="sub-toggle"><i className="fa fa-angle-down" /></span>
                                <ul className="sub-menu">
                                ...
                                <li className="current-menu-item menu-item-has-children"><a href="shop-default.html">Washing Machines</a><span className="sub-toggle"><i className="fa fa-angle-down" /></span>
                                <ul className="sub-menu">
                            ...
                            <li className="current-menu-item menu-item-has-children"><a href="shop-default.html">Health &amp; Beauty</a><span className="sub-toggle"><i className="fa fa-angle-down" /></span>
                            <ul className="sub-menu">
                            ...
                            <li className="current-menu-item menu-item-has-children"><a href="shop-default.html">Computers &amp; Technologies</a><span className="sub-toggle"><i className="fa fa-angle-down" /></span>
                            <ul className="sub-menu">
                            ...
                            <li className="current-menu-item menu-item-has-children"><a href="shop-default.html">Jewelry &amp; Watches</a><span className="sub-toggle"><i className="fa fa-angle-down" /></span>
                            <ul className="sub-menu">
                            ...
                            <li className="current-menu-item menu-item-has-children"><a href="shop-default.html">Phones &amp; Accessories</a><span className="sub-toggle"><i className="fa fa-angle-down" /></span>
                            <ul className="sub-menu">
                            ...
                            <li className="current-menu-item menu-item-has-children"><a href="shop-default.html">Sport &amp; Outdoor</a><span className="sub-toggle"><i className="fa fa-angle-down" /></span>
                            <ul className="sub-menu">
                        ...
                        <figure>
                            ...
                            <div id="nonlinear" />
                            <p className="ps-slider__meta">Price:<span className="ps-slider__value">$<span className="ps-slider__min" /></span>-<span className="ps-slider__value">$<span className="ps-slider__max" /></span></p>
                        </figure>
                        <figure>
                            <h4 className="widget-title">By Price</h4>
                            <div className="ps-checkbox">
                            <input className="form-control" type="checkbox" id="review-1" name="review" />
                            <label htmlFor="review-1"><span><i className="fa fa-star rate" /><i className="fa fa-star rate" /><i className="fa fa-star rate" /><i className="fa fa-star rate" /><i className="fa fa-star rate" /></span><small>(13)</small></label>
                            </div>
                            <div className="ps-checkbox">
                            <input className="form-control" type="checkbox" id="review-2" name="review" />
                            <label htmlFor="review-2"><span><i className="fa fa-star rate" /><i className="fa fa-star rate" /><i className="fa fa-star rate" /><i className="fa fa-star rate" /><i className="fa fa-star" /></span><small>(13)</small></label>
                            </div>
                            <div className="ps-checkbox">
                            <input className="form-control" type="checkbox" id="review-3" name="review" />
                            <label htmlFor="review-3"><span><i className="fa fa-star rate" /><i className="fa fa-star rate" /><i className="fa fa-star rate" /><i className="fa fa-star" /><i className="fa fa-star" /></span><small>(5)</small></label>
                            </div>
                            <div className="ps-checkbox">
                            <input className="form-control" type="checkbox" id="review-4" name="review" />
                            <label htmlFor="review-4"><span><i className="fa fa-star rate" /><i className="fa fa-star rate" /><i className="fa fa-star" /><i className="fa fa-star" /><i className="fa fa-star" /></span><small>(5)</small></label>
                            </div>
                            <div className="ps-checkbox">
                            <input className="form-control" type="checkbox" id="review-5" name="review" />
                            <label htmlFor="review-5"><span><i className="fa fa-star rate" /><i className="fa fa-star" /><i className="fa fa-star" /><i className="fa fa-star" /><i className="fa fa-star" /></span><small>(1)</small></label>
                            </div>
                        </figure>
                        <figure>
                    ...
                    <div className="ps-layout__right">
                        ...
                        <div className="ps-block__header">
                            ...
                            <div className="ps-block__navigation"><a className="ps-carousel__prev" href="#recommended1"><i className="icon-chevron-left" /></a><a className="ps-carousel__next" href="#recommended1"><i className="icon-chevron-right" /></a></div>
                        </div>
                        <div className="ps-block__content">
                            <div className="owl-slider" id="recommended1" data-owl-auto="true" data-owl-loop="true" data-owl-speed={10000} data-owl-gap={30} data-owl-nav="false" data-owl-dots="false" data-owl-item={6} data-owl-item-xs={2} data-owl-item-sm={2} data-owl-item-md={3} data-owl-item-lg={4} data-owl-item-xl={5} data-owl-duration={1000} data-owl-mousedrag="on">
                            <div className="ps-product">
                                <div className="ps-product__thumbnail"><a href="product-default.html"><img src="img/products/shop/best/1.jpg" alt="" /></a>
                                <ul className="ps-product__actions">
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add To Cart"><i className="icon-bag2" /></a></li>
                            ...
                            <div className="ps-product">
                                <div className="ps-product__thumbnail"><a href="product-default.html"><img src="img/products/shop/best/2.jpg" alt="" /></a>
                            ...
                            <div className="ps-product">
                                <div className="ps-product__thumbnail"><a href="product-default.html"><img src="img/products/shop/best/3.jpg" alt="" /></a>
                                ...
                                <div className="ps-product__content"><a className="ps-product__title" href="product-default.html">Unero Military Classical Backpack</a>
                                    ...
                                    <p className="ps-product__price sale">$35.00 <del>$60.00 </del></p>
                                </div>
                            ...
                            <div className="ps-product">
                                <div className="ps-product__thumbnail"><a href="product-default.html"><img src="img/products/shop/best/4.jpg" alt="" /></a>
                                ...
                                <div className="ps-product__content"><a className="ps-product__title" href="product-default.html">Sound Intone I65 Earphone White Version</a>
                                    ...
                                    <p className="ps-product__price sale">$100.00 <del>$105.00 </del></p>
                                </div>
                            ...
                            <div className="ps-product">
                                <div className="ps-product__thumbnail"><a href="product-default.html"><img src="img/products/shop/best/5.jpg" alt="" /></a>
                                <ul className="ps-product__actions">
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add To Cart"><i className="icon-bag2" /></a></li>
                                    <li><a href="#" data-placement="top" title="Quick View" data-toggle="modal" data-target="#product-quickview"><i className="icon-eye" /></a></li>
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i className="icon-heart" /></a></li>
                            ...
                            <div className="ps-product">
                                <div className="ps-product__thumbnail"><a href="product-default.html"><img src="img/products/shop/best/6.jpg" alt="" /></a>
                                ...
                                <div className="ps-product__content"><a className="ps-product__title" href="product-default.html">Xbox One Wireless Controller Black Color</a>
                                    ...
                                    <p className="ps-product__price sale">$1025.00 <del>$1422.00 </del></p>
                                </div>
                            ...
                            <div className="ps-product">
                                <div className="ps-product__thumbnail"><a href="product-default.html"><img src="img/products/shop/best/7.jpg" alt="" /></a>
                                <ul className="ps-product__actions">
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add To Cart"><i className="icon-bag2" /></a></li>
                                    <li><a href="#" data-placement="top" title="Quick View" data-toggle="modal" data-target="#product-quickview"><i className="icon-eye" /></a></li>
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i className="icon-heart" /></a></li>
                        ...
                        <div className="ps-block__header">
                            ...
                            <div className="ps-block__navigation"><a className="ps-carousel__prev" href="#recommended"><i className="icon-chevron-left" /></a><a className="ps-carousel__next" href="#recommended"><i className="icon-chevron-right" /></a></div>
                        </div>
                        <div className="ps-block__content">
                            <div className="owl-slider" id="recommended" data-owl-auto="true" data-owl-loop="true" data-owl-speed={10000} data-owl-gap={30} data-owl-nav="false" data-owl-dots="false" data-owl-item={6} data-owl-item-xs={2} data-owl-item-sm={2} data-owl-item-md={3} data-owl-item-lg={4} data-owl-item-xl={5} data-owl-duration={1000} data-owl-mousedrag="on">
                            <div className="ps-product">
                                <div className="ps-product__thumbnail"><a href="product-default.html"><img src="img/products/shop/recommended/1.jpg" alt="" /></a>
                                ...
                                <div className="ps-product__container"><a className="ps-product__vendor" href="#">Young Shop</a>
                                <div className="ps-product__content"><a className="ps-product__title" href="product-default.html">Ciate Palemore Lipstick Bold Red Color</a>
                                    <div className="ps-product__rating">
                                    <select className="ps-rating" data-read-only="true">
                                        <option value={1}>1</option>
                                        <option value={1}>2</option>
                                    ...
                                    <p className="ps-product__price sale">$42.99 <del>$60.00 </del></p>
                                </div>
                                <div className="ps-product__content hover"><a className="ps-product__title" href="product-default.html">Ciate Palemore Lipstick Bold Red Color</a>
                                    <p className="ps-product__price sale">$42.99 <del>$60.00 </del></p>
                                </div>
                                </div>
                            </div>
                            <div className="ps-product">
                                <div className="ps-product__thumbnail"><a href="product-default.html"><img src="img/products/shop/recommended/2.jpg" alt="" /></a>
                                <div className="ps-product__badge">-37%</div>
                                <ul className="ps-product__actions">
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add To Cart"><i className="icon-bag2" /></a></li>
                                    <li><a href="#" data-placement="top" title="Quick View" data-toggle="modal" data-target="#product-quickview"><i className="icon-eye" /></a></li>
                                ...
                                <div className="ps-product__container"><a className="ps-product__vendor" href="#">Robert's Store</a>
                                <div className="ps-product__content"><a className="ps-product__title" href="product-default.html">Set 30 Piece Korea StartSkin Natural Mask</a>
                                    <div className="ps-product__rating">
                                    <select className="ps-rating" data-read-only="true">
                                        <option value={1}>1</option>
                                        <option value={1}>2</option>
                                    ...
                                    <p className="ps-product__price sale">$32.99 <del>$60.00 </del></p>
                                </div>
                                <div className="ps-product__content hover"><a className="ps-product__title" href="product-default.html">Set 30 Piece Korea StartSkin Natural Mask</a>
                                    <p className="ps-product__price sale">$32.99 <del>$60.00 </del></p>
                                </div>
                                </div>
                            </div>
                            <div className="ps-product">
                                <div className="ps-product__thumbnail"><a href="product-default.html"><img src="img/products/shop/recommended/3.jpg" alt="" /></a>
                                ...
                                <div className="ps-product__container"><a className="ps-product__vendor" href="#">Go Pro</a>
                                <div className="ps-product__content"><a className="ps-product__title" href="product-default.html">Baxter Care Hair Kit For Bearded Mens</a>
                                    <div className="ps-product__rating">
                                    <select className="ps-rating" data-read-only="true">
                                        <option value={1}>1</option>
                                        <option value={1}>2</option>
                                    ...
                                    <p className="ps-product__price sale">$93.00 <del>$60.00 </del></p>
                                </div>
                                <div className="ps-product__content hover"><a className="ps-product__title" href="product-default.html">Baxter Care Hair Kit For Bearded Mens</a>
                                    <p className="ps-product__price sale">$93.00 <del>$60.00 </del></p>
                                </div>
                                </div>
                            </div>
                            <div className="ps-product">
                                <div className="ps-product__thumbnail"><a href="product-default.html"><img src="img/products/shop/recommended/4.jpg" alt="" /></a>
                                ...
                                <div className="ps-product__content"><a className="ps-product__title" href="product-default.html">Letter Printed Cushion Cover Cotton</a>
                                    ...
                                    <p className="ps-product__price sale">$13.00 <del>$20.00 </del></p>
                                </div>
                            ...
                            <div className="ps-product">
                                <div className="ps-product__thumbnail"><a href="product-default.html"><img src="img/products/shop/recommended/5.jpg" alt="" /></a>
                                <div className="ps-product__badge">-46%</div>
                                <ul className="ps-product__actions">
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add To Cart"><i className="icon-bag2" /></a></li>
                                    <li><a href="#" data-placement="top" title="Quick View" data-toggle="modal" data-target="#product-quickview"><i className="icon-eye" /></a></li>
                            ...
                            <div className="ps-product">
                                <div className="ps-product__thumbnail"><a href="product-default.html"><img src="img/products/shop/recommended/6.jpg" alt="" /></a>
                            ...
                            <div className="ps-product">
                                <div className="ps-product__thumbnail"><a href="product-default.html"><img src="img/products/shop/recommended/7.jpg" alt="" /></a>
                                <ul className="ps-product__actions">
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add To Cart"><i className="icon-bag2" /></a></li>
                                    <li><a href="#" data-placement="top" title="Quick View" data-toggle="modal" data-target="#product-quickview"><i className="icon-eye" /></a></li>
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i className="icon-heart" /></a></li>
                        ...
                        <div className="ps-shopping__header">
                            ...
                            <div className="ps-shopping__view">
                                ...
                                <li className="active"><a href="#tab-1"><i className="icon-grid" /></a></li>
                                <li><a href="#tab-2"><i className="icon-list4" /></a></li>
                                </ul>
                            </div>
                            </div>
                        </div>
                        <div className="ps-tabs">
                            ...
                            <div className="ps-shopping-product">
                                ...
                                <div className="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-6 ">
                                    <div className="ps-product">
                                    <div className="ps-product__thumbnail"><a href="product-default.html"><img src="img/products/shop/1.jpg" alt="" /></a>
                                        <ul className="ps-product__actions">
                                        <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add To Cart"><i className="icon-bag2" /></a></li>
                                        <li><a href="#" data-placement="top" title="Quick View" data-toggle="modal" data-target="#product-quickview"><i className="icon-eye" /></a></li>
                                        <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i className="icon-heart" /></a></li>
                                ...
                                <div className="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-6 ">
                                    <div className="ps-product">
                                    <div className="ps-product__thumbnail"><a href="product-default.html"><img src="img/products/shop/2.jpg" alt="" /></a>
                                        <ul className="ps-product__actions">
                                        <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add To Cart"><i className="icon-bag2" /></a></li>
                                        <li><a href="#" data-placement="top" title="Quick View" data-toggle="modal" data-target="#product-quickview"><i className="icon-eye" /></a></li>
                                        <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i className="icon-heart" /></a></li>
                                    ...
                                    <div className="ps-product__container"><a className="ps-product__vendor" href="#">Go Pro</a>
                                        ...
                                        <div className="ps-product__content hover"><a className="ps-product__title" href="product-default.html">Marshall Kilburn Portable Wireless Speaker</a>
                                        <p className="ps-product__price">$42.99 - $60.00</p>
                                        </div>
                                    </div>
                                    </div>
                                ...
                                <div className="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-6 ">
                                    <div className="ps-product">
                                    <div className="ps-product__thumbnail"><a href="product-default.html"><img src="img/products/shop/3.jpg" alt="" /></a>
                                        <ul className="ps-product__actions">
                                        <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add To Cart"><i className="icon-bag2" /></a></li>
                                        <li><a href="#" data-placement="top" title="Quick View" data-toggle="modal" data-target="#product-quickview"><i className="icon-eye" /></a></li>
                                        <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i className="icon-heart" /></a></li>
                                ...
                                <div className="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-6 ">
                                    <div className="ps-product">
                                    <div className="ps-product__thumbnail"><a href="product-default.html"><img src="img/products/shop/10.jpg" alt="" /></a>
                                        <ul className="ps-product__actions">
                                        <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add To Cart"><i className="icon-bag2" /></a></li>
                                        <li><a href="#" data-placement="top" title="Quick View" data-toggle="modal" data-target="#product-quickview"><i className="icon-eye" /></a></li>
                                        <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i className="icon-heart" /></a></li>
                            ...
                            <div className="ps-pagination">
                                ...
                                <li><a href="#">2</a></li>
                                <li><a href="#">3</a></li>
                                <li><a href="#">Next Page<i className="icon-chevron-right" /></a></li>
                                </ul>
                            </div>
                            </div>
                            ...
                            <div className="ps-shopping-product">
                                ...
                                <div className="ps-product__container">
                                    <div className="ps-product__content"><a className="ps-product__title" href="product-default.html">Apple iPhone Retina 6s Plus 64GB</a>
                                    <p className="ps-product__vendor">Sold by:<a href="#">ROBERT’S STORE</a></p>
                                    ...
                                    <p className="ps-product__price">$1310.00</p><a className="ps-btn" href="#">Add to cart</a>
                                    <ul className="ps-product__actions">
                                        <li><a href="#"><i className="icon-heart" /> Wishlist</a></li>
                                        <li><a href="#"><i className="icon-chart-bars" /> Compare</a></li>
                                    </ul>
                                    </div>
                                </div>
                                </div>
                                ...
                                <div className="ps-product__container">
                                    <div className="ps-product__content"><a className="ps-product__title" href="product-default.html">Apple iPhone Retina 6s Plus 64GB</a>
                                    <p className="ps-product__vendor">Sold by:<a href="#">Young Shop</a></p>
                                    <ul className="ps-product__desc">
                                        <li> Unrestrained and portable active stereo speaker</li>
                                        <li> Free from the confines of wires and chords</li>
                                        <li> 20 hours of portable capabilities</li>
                                    ...
                                    <div className="ps-product__shopping">
                                    <p className="ps-product__price">$1150.00</p><a className="ps-btn" href="#">Add to cart</a>
                                    <ul className="ps-product__actions">
                                        <li><a href="#"><i className="icon-heart" /> Wishlist</a></li>
                                        <li><a href="#"><i className="icon-chart-bars" /> Compare</a></li>
                                    </ul>
                                ...
                                <div className="ps-product__container">
                                    ...
                                    <p className="ps-product__vendor">Sold by:<a href="#">Go Pro</a></p>
                                    <ul className="ps-product__desc">
                                        <li> Unrestrained and portable active stereo speaker</li>
                                        <li> Free from the confines of wires and chords</li>
                                        <li> 20 hours of portable capabilities</li>
                                    ...
                                    <div className="ps-product__shopping">
                                    <p className="ps-product__price">$42.99 - $60.00</p><a className="ps-btn" href="#">Add to cart</a>
                                    <ul className="ps-product__actions">
                                        <li><a href="#"><i className="icon-heart" /> Wishlist</a></li>
                                        <li><a href="#"><i className="icon-chart-bars" /> Compare</a></li>
                                    </ul>
                                ...
                                <div className="ps-product__container">
                                    ...
                                    <div className="ps-product__shopping">
                                    <p className="ps-product__price">$125.30</p><a className="ps-btn" href="#">Add to cart</a>
                                    <ul className="ps-product__actions">
                                        <li><a href="#"><i className="icon-heart" /> Wishlist</a></li>
                                        <li><a href="#"><i className="icon-chart-bars" /> Compare</a></li>
                                    </ul>
                                ...
                                <div className="ps-product__container">
                                    ...
                                    <p className="ps-product__vendor">Sold by:<a href="#">Global Office</a></p>
                                    <ul className="ps-product__desc">
                                        <li> Unrestrained and portable active stereo speaker</li>
                                        <li> Free from the confines of wires and chords</li>
                                        <li> 20 hours of portable capabilities</li>
                                    ...
                                    <div className="ps-product__shopping">
                                    <p className="ps-product__price">$55.99</p><a className="ps-btn" href="#">Add to cart</a>
                                    <ul className="ps-product__actions">
                                        <li><a href="#"><i className="icon-heart" /> Wishlist</a></li>
                                        <li><a href="#"><i className="icon-chart-bars" /> Compare</a></li>
                                    </ul>
                                ...
                                <div className="ps-product__container">
                                    ...
                                    <div className="ps-product__shopping">
                                    <p className="ps-product__price sale">$32.99 <del>$41.00 </del></p><a className="ps-btn" href="#">Add to cart</a>
                                    <ul className="ps-product__actions">
                                        <li><a href="#"><i className="icon-heart" /> Wishlist</a></li>
                                        <li><a href="#"><i className="icon-chart-bars" /> Compare</a></li>
                                    </ul>
                                ...
                                <div className="ps-product__container">
                                    ...
                                    <p className="ps-product__vendor">Sold by:<a href="#">Youngshop</a></p>
                                    <ul className="ps-product__desc">
                                        <li> Unrestrained and portable active stereo speaker</li>
                                        <li> Free from the confines of wires and chords</li>
                                        <li> 20 hours of portable capabilities</li>
                                    ...
                                    <div className="ps-product__shopping">
                                    <p className="ps-product__price sale">$100.99 <del>$106.00 </del></p><a className="ps-btn" href="#">Add to cart</a>
                                    <ul className="ps-product__actions">
                                        <li><a href="#"><i className="icon-heart" /> Wishlist</a></li>
                                        <li><a href="#"><i className="icon-chart-bars" /> Compare</a></li>
                                    </ul>
                                ...
                                <div className="ps-product__container">
                                    ...
                                    <div className="ps-product__shopping">
                                    <p className="ps-product__price sale">$567.89 <del>$670.20 </del></p><a className="ps-btn" href="#">Add to cart</a>
                                    <ul className="ps-product__actions">
                                        <li><a href="#"><i className="icon-heart" /> Wishlist</a></li>
                                        <li><a href="#"><i className="icon-chart-bars" /> Compare</a></li>
                                    </ul>
                                ...
                                <div className="ps-product__container">
                                    ...
                                    <div className="ps-product__shopping">
                                    <p className="ps-product__price sale">$35.89 <del>$42.20 </del></p><a className="ps-btn" href="#">Add to cart</a>
                                    <ul className="ps-product__actions">
                                        <li><a href="#"><i className="icon-heart" /> Wishlist</a></li>
                                        <li><a href="#"><i className="icon-chart-bars" /> Compare</a></li>
                                    </ul>
                                ...
                                <div className="ps-product__container">
                                    ...
                                    <div className="ps-product__shopping">
                                    <p className="ps-product__price">$35.89</p><a className="ps-btn" href="#">Add to cart</a>
                                    <ul className="ps-product__actions">
                                        <li><a href="#"><i className="icon-heart" /> Wishlist</a></li>
                                        <li><a href="#"><i className="icon-chart-bars" /> Compare</a></li>
                                    </ul>
                                ...
                                <div className="ps-product__container">
                                    ...
                                    <div className="ps-product__shopping">
                                    <p className="ps-product__price">$29.39 - $39.99</p><a className="ps-btn" href="#">Add to cart</a>
                                    <ul className="ps-product__actions">
                                        <li><a href="#"><i className="icon-heart" /> Wishlist</a></li>
                                        <li><a href="#"><i className="icon-chart-bars" /> Compare</a></li>
                                    </ul>
                                ...
                                <div className="ps-product__container">
                                    ...
                                    <div className="ps-product__shopping">
                                    <p className="ps-product__price">$13.43</p><a className="ps-btn" href="#">Add to cart</a>
                                    <ul className="ps-product__actions">
                                        <li><a href="#"><i className="icon-heart" /> Wishlist</a></li>
                                        <li><a href="#"><i className="icon-chart-bars" /> Compare</a></li>
                                    </ul>
                    ...
                    <div className="modal" id="shop-filter-lastest" tabIndex={-1} role="dialog">
                    <div className="modal-dialog modal-dialog-centered" role="document">
                        <div className="modal-content">
                        <div className="modal-body">
                            <div className="list-group"><a className="list-group-item list-group-item-action" href="#">Sort by</a><a className="list-group-item list-group-item-action" href="#">Sort by average rating</a><a className="list-group-item list-group-item-action" href="#">Sort by latest</a><a className="list-group-item list-group-item-action" href="#">Sort by price: low to high</a><a className="list-group-item list-group-item-action" href="#">Sort by price: high to low</a><a className="list-group-item list-group-item-action text-center" href="#" data-dismiss="modal"><strong>Close</strong></a></div>
                        </div>
                        </div>
                    </div>
                    </div>
